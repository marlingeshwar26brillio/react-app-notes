...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 to-slate-100 dark:from-neutral-900 dark:to-neutral-900 relative overflow-hidden transition-colors duration-300">
      <GridPattern
        width={42}
        height={42}
      ...
      />
      {/* Navbar */}
        <nav className="sticky top-0 z-50 bg-white/80 dark:bg-neutral-900/80 backdrop-blur border-b border-slate-200 dark:border-neutral-800 transition-colors">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          {user ? (
            <div className="flex items-center gap-3">
              ...
              <Link
                to="/app"
                className="px-4 py-2 rounded-lg text-slate-700 dark:text-neutral-300 hover:bg-slate-100 dark:hover:bg-neutral-800 transition-colors font-medium"
              >
                Notes
              </Link>
              <Link
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-20 md:py-32">
        <div className="text-center">
          <h2 className="text-5xl md:text-6xl font-bold text-slate-900 dark:text-neutral-100 mb-6 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            {!user && (
              <Link 
                to="/login"
                className="px-8 py-4 border-2 border-slate-300 dark:border-neutral-700 text-slate-900 dark:text-neutral-100 hover:bg-slate-100 dark:hover:bg-neutral-800 rounded-xl transition-colors font-semibold text-lg"
              >
                Sign In
              </Link>
            )}
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        <h3 className="text-4xl font-bold text-center text-slate-900 dark:text-neutral-100 mb-16">
          Why Choose Notely?
        </h3>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-md hover:shadow-lg transition-shadow border border-slate-200 dark:border-neutral-700">
            <div className="text-4xl mb-4">✍️</div>
            <h4 className="text-xl font-bold text-slate-900 dark:text-neutral-100 mb-3">Fast & Easy</h4>
          ...
          <div className="bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-md hover:shadow-lg transition-shadow border border-slate-200 dark:border-neutral-700">
            <div className="text-4xl mb-4">🏷️</div>
            <h4 className="text-xl font-bold text-slate-900 dark:text-neutral-100 mb-3">Organize with Tags</h4>
            <p className="text-slate-600 dark:text-neutral-400">
          ...
          <div className="bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-md hover:shadow-lg transition-shadow border border-slate-200 dark:border-neutral-700">
            ...
            <h4 className="text-xl font-bold text-slate-900 dark:text-neutral-100 mb-3">Dark Mode</h4>
            <p className="text-slate-600 dark:text-neutral-400">
          ...
          <div className="bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-md hover:shadow-lg transition-shadow border border-slate-200 dark:border-neutral-700">
            <div className="text-4xl mb-4">🔍</div>
            <h4 className="text-xl font-bold text-slate-900 dark:text-neutral-100 mb-3">Smart Search</h4>
            <p className="text-slate-600 dark:text-neutral-400">
          ...
          <div className="bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-md hover:shadow-lg transition-shadow border border-slate-200 dark:border-neutral-700">
            <div className="text-4xl mb-4">🗑️</div>
            <h4 className="text-xl font-bold text-slate-900 dark:text-neutral-100 mb-3">Trash & Restore</h4>
            <p className="text-slate-600 dark:text-neutral-400">
          ...
          <div className="bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-md hover:shadow-lg transition-shadow border border-slate-200 dark:border-neutral-700">
            <div className="text-4xl mb-4">💾</div>
            <h4 className="text-xl font-bold text-slate-900 dark:text-neutral-100 mb-3">Auto-Save</h4>
            <p className="text-slate-600 dark:text-neutral-400">
      ...
      {/* Footer */}
      <footer className="relative z-10 bg-slate-100 dark:bg-neutral-950 border-t border-slate-200 dark:border-neutral-800 py-12 mt-20 transition-colors">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-bold text-slate-900 dark:text-neutral-100">Notely</h3>
              </div>
            ...
            <div>
              <h4 className="font-semibold text-slate-900 dark:text-neutral-100 mb-4">Product</h4>
            ...
            <div>
              <h4 className="font-semibold text-slate-900 dark:text-neutral-100 mb-4">Connect</h4>
              <ul className="space-y-2 text-sm text-slate-600 dark:text-neutral-400">
          ...
          <div className="border-t border-slate-200 dark:border-neutral-800 pt-8 text-center text-slate-600 dark:text-neutral-500 text-sm">
